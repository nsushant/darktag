...
Usage:
    python scripts/run_tag_dm_be.py Halo1459_DMO \
        --be-cache Halo1459_DMO_binding_energies.hdf5 \
        --n-instances 50
    python scripts/run_tag_dm_be.py Halo1459_DMO_Mreionx02 \
        --be-cache Halo1459_DMO_Mreionx02_binding_energies.hdf5 \
        --track-cluster-file Halo1459_DMO_Mreionx02_cluster_tree.hdf5 \
        --n-instances 50 --ftag 0.01 --db-name Halo1459
"""
...
from darktag.tagging.binding_energy_tagging import be_tag_multi_instance
...
def main():
    ...
    output_prefix = args.output_prefix or f'{sim_name}_tagged_dm_be'
